package com.renyujie.gulimall.search;
...
public class GulimallSearchApplicationTests {
	...
	public void contextLoads() {
		System.out.println("打印出地址说明可以操作es:" + client);
	}

	/**
	 * 测试存储数据到es
	 * 保存 --更新也可以(返回的version+1)
	 */
	@Data
	class User{
		String userName;
...
//        indexRequest.source("username", "zhangsan", "age", 18, "gender", "男");
	...
	/**
	 * @Description: 复杂检索
	 * 搜索 address中包合mill的所有人的年龄分布以及平均年龄,
	 */
	@Test
...
//        sourceBuilder.aggregation();
		...
		//3 分析结果 searchResponse 对应到Account.class对象
...
//            hit.getId();
			...
			System.out.println("每一条命中的记录："+account);
		}
